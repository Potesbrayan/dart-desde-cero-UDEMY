import 'dart:convert'; // de acá también se saca los   json, jsonDecode, jsonCode ....

import 'package:paquetes/clases/regionalBloc.dart';
import 'package:paquetes/clases/traslations.dart';

import 'currecy.dart';
import 'languague.dart';  


// To parse required this JSON data, do
//
//     final pais = paisFromMap(jsonString);



Pais paisFromMap(String str) => Pais.fromMap(json.decode(str));

String paisToMap(Pais data) => json.encode(data.toMap());
